 ...
 * @author Alicea
 */
public class PopupAltSucesso extends javax.swing.JFrame {

    /**
     * Creates new form PopupAltSucesso
     */
    public PopupAltSucesso() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        texto1.setText("Dado alterado com sucesso!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupAltSucesso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupAltSucesso().setVisible(true);
            }
        });
    }
